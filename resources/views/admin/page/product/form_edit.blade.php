...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="add-product-post-form" method="POST" action="{{ route('product.update') }}">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">{{ trans('Sửa Sản Phẩm') }}</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                         value="{{ old('name', "") }}"
                                    @endif
                                    name="name" id="name" placeholder="{{ __('Nhập tên sản phẩm') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="price"
                                           ...
                                           value="{{ old('price', "") }}"
                                           @endif
                                    id="price" placeholder="{{ __('Nhập giá sản phẩm') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="20">{{ old('description', $product->description) }}</textarea>
    ...
    @include('admin.page.product.js.logic_js_edit_product')
@stop
